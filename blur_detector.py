# -*- coding: utf-8 -*-
"""
Created on Tue Jun 27 10:28:40 2023
Blur detection on the single-nuclei image patches
@author: arojhada
"""
...
import numpy as np
def detect_blur_fft(image, size=60, thresh=-32, vis=False):
...
ap.add_argument("-t", "--thresh", type=int, default=-32,
